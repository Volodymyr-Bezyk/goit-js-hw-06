const makeQuantityOfCategories = () =>
  console.log(
...
const makeTitleAndQuantityOfElements = item => {
  ...
  const elementsAmountOfCategory =
    titleOfCategory.nextElementSibling.children.length;
...
const titleOfCategoryAndQuantityOfElements = () => {
  ...
  const titleAndElementsOfCategory = listOfCategoriesRef.map(
    makeTitleAndQuantityOfElements
  );
};

makeQuantityOfCategories();
